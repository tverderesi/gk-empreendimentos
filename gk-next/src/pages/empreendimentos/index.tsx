...
export default function Buildings() {
  ...
  const buildings = [
    {
      name: "Lumina",
      imgSrc: require("~/assets/buildings/lumina/lumina.jpg"),
    },
    {
      name: "Adra",
      imgSrc: "",
          ...
          <FilterManager filter={filter} filteringProp="status">
            <CustomBuildingBadge icon="workspace_premium" status="new">
              <GridItem
                name={"Lumina"}
                imgSrc={require("~/assets/buildings/lumina/lumina.jpg")}
                logoSrc={require("~/assets/buildings/lumina/lumina-logo.png")}
              />
            </CustomBuildingBadge>
            <CustomBuildingBadge icon="construction" status="ongoing">
              <GridItem
                name={"Adra"}
                imgSrc={require("~/assets/buildings/adra/adra.jpg")}
                logoSrc={require("~/assets/buildings/adra/adra-logo.png")}
              />
            </CustomBuildingBadge>
            <CustomBuildingBadge icon="task_alt" status="sold">
              <GridItem
                name={"Aion"}
                imgSrc={require("~/assets/buildings/aion/aion.png")}
                logoSrc={require("~/assets/buildings/aion/aion-logo.png")}
              />
            </CustomBuildingBadge>
            <CustomBuildingBadge icon="task_alt" status="sold">
              <GridItem
                name={"San Diego"}
                imgSrc={require("~/assets/buildings/san-diego/sanDiego.jpg")}
                logoSrc={require("~/assets/buildings/san-diego/sanDiego-logo.png")}
              />
            </CustomBuildingBadge>
            <CustomBuildingBadge icon="task_alt" status="sold">
              <GridItem
                name={"Porto Madero"}
                imgSrc={require("~/assets/buildings/porto-madero/portoMadero.jpg")}
                logoSrc={require("~/assets/buildings/porto-madero/portoMadero-logo.png")}
              />
            </CustomBuildingBadge>
            <CustomBuildingBadge icon="task_alt" status="sold">
              <GridItem
                name={"Porto Fino"}
                imgSrc={require("~/assets/buildings/porto-fino/portoFino.jpg")}
                logoSrc={require("~/assets/buildings/porto-fino/portoFino-logo.png")}
              />
            </CustomBuildingBadge>
            <CustomBuildingBadge icon="task_alt" status="sold">
              <GridItem
                name={"Varandas do Atlântico"}
                imgSrc={require("~/assets/buildings/varandas-do-atlantico/varandasAtlantico.jpg")}
                logoSrc={require("~/assets/buildings/varandas-do-atlantico/varandasAtlantico-logo.png")}
              />
            </CustomBuildingBadge>
            <CustomBuildingBadge icon="task_alt" status="sold">
              <GridItem
                name={"Rio Maggiore"}
                imgSrc={require("~/assets/buildings/rio-maggiore/rioMaggiore.jpg")}
                logoSrc={require("~/assets/buildings/rio-maggiore/rioMaggiore-logo.png")}
              />
            </CustomBuildingBadge>
          </FilterManager>
        </Grid>
